...
public class RememberingJava {
    public static void main(String[] args) {
        ...
        // 2. There is no memory manipulation in Java
        ...
        // What is a Java Package and which package is imported by default? Java compiler imports java. lang package
        // internally by default. It provides the fundamental classes that are necessary to design a basic Java program.
        String abc = "hello";

        // Why Java is not a pure Object Oriented language? Since we have primitive data types, Java is not
        // a pure Object Oriented language
        int num = 5;

        // What is a "final" keyword? final makes it immutable
