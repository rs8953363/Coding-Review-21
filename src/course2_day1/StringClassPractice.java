...
public class StringClassPractice {
    ...
    // It is a final and immutable(not changeable) clas// What are different ways to create String Object?
   ...
   // Obtaining Substrings >> message.substring(beginIncluded, endsNOTincluded)// Stringbuffer and Stringbuilder <speed comparison>
